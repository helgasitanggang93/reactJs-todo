...
describe('Reducer Result Testing', () => {
    ...
    it('IS_DETAIL work properly', () => {
        ...
        expect(newState.reducer).toEqual({...initialState, isDetail: action.payload})
    })
    ...
    it('IS_LOGIN_REGISTER work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, isLoginRegister: action.payload , isLoading: false})
    })
    ...
    it('IS_LOGIN work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, isLogin: action.payload})
    })
    ...
    it('IS_REGISTER work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, isRegister: action.payload})
    })
    ...
    it('IS_GOOGLE_SIGN_IN work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, isGoogleSignIn: action.payload})
    })
    ...
    it('ITEM_ERROR work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, errorMessage: action.payload, isLoading: false})
    })
    ...
    it('FORM_MODAL_HANDLER work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, isForm: action.payload})
    })
    ...
    it('FETCH_TODO_DATA work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, todos: action.payload})
    })
    ...
    it('FETCH_TODO_DATA work properly', () => {
        ...
        const newState = reducer({}, action)
        expect(newState.reducer).toEqual({...initialState, detail: action.payload})
    })
